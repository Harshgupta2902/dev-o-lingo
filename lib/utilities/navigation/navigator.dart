...
class MyNavigator {
  ...
  static void pushNamed(String? routeName, {Object? extra}) {
    try {
      goRouterConfig.pushNamed(routeName ?? GoPaths.login, extra: extra);
    } catch (e) {
  ...
  static void pushReplacementNamed(String? routeName, {Object? extra}) {
    try {
      goRouterConfig.pushReplacementNamed(routeName ?? GoPaths.login,
          extra: extra);
    } catch (e) {
      debugPrint("+++++++++++++++++++++++++++++navigation  $e");
    }
  ...
  static void _logNavigationEvent(String? routeName) {
    FirebaseAnalytics.instance.logEvent(
      ...
      parameters: {
        'page_name': routeName ?? GoPaths.login,
      },
    );
  }
}
